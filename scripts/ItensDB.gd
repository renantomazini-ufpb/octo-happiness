@export var comidas = [
	...
	{"nome":"Sushi","icone":preload("res://icon.svg"),"preco":45.0,"fome":100,"energia":25,"calma":60}
]
...
@export var bebidas = [
	...
	{"nome":"Monster","icone":preload("res://icon.svg"),"preco":14.0,"sede":15,"calma":20,"energia":45},
	{"nome":"Redbull","icone":preload("res://icon.svg"),"preco":9.0,"sede":15,"calma":10,"energia":30},
...
@export var dormir = [
	...
	{"nome":"Dormir completo","calma":60,"energia":90,"tempo":480,"icone":preload("res://icon.svg")}
]
...
@export var trabalhar = [
	...
	{"nome":"Empreender","fome": -10,"sede": -25,"salario":5.0,"tempo":30,"calma":-35,"req_estudo":3.5,"energia": -20,"icone":preload("res://icon.svg")},
	{"nome":"Projeto pessoal","fome": -10,"sede": -25,"salario_mult":10,"tempo":60,"calma":-10,"req_estudo":4.0,"energia": -30,"icone":preload("res://icon.svg")},
	{"nome":"Mercado","fome": -10,"sede": -25,"salario":6.0,"tempo":60,"calma":-70,"req_estudo":2.0,"energia": -40,"icone":preload("res://icon.svg")},
	{"nome":"Estágio","fome": -10,"sede": -25,"salario":7.5,"tempo":60,"calma":-50,"req_estudo":3.5,"energia": -30,"icone":preload("res://icon.svg")},
	{"nome":"Freelancer exterior","fome": -10,"sede": -25,"salario":10.0,"tempo":60,"calma":-20,"req_estudo":7.0,"energia": -30,"icone":preload("res://icon.svg")},
	{"nome":"CLT básico","fome": -10,"sede": -25,"salario":13.0,"tempo":120,"calma":-40,"req_estudo":7.5,"energia": -20,"icone":preload("res://icon.svg")},
	{"nome":"Dar aula","fome": -10,"sede": -25,"salario":18.0,"tempo":60,"calma":-50,"req_estudo":10.5,"energia": -25,"icone":preload("res://icon.svg")},
	{"nome":"Ajudar colegas","fome": -10,"sede": -25,"salario":21.0,"tempo":60,"calma":-50,"req_estudo":9.0,"energia": -20,"icone":preload("res://icon.svg")},
	{"nome":"CLT avançado","fome": -10,"sede": -25,"salario":34.0,"tempo":120,"calma":-30,"req_estudo":15.0,"energia": -15,"icone":preload("res://icon.svg")}
]
...
@export var socializar = [
	...
	{"nome":"Festa","preco":25.0,"fome": -10,"sede": -25,"tempo":120,"calma":30,"social":40,"energia":-20,"icone":preload("res://icon.svg")}
]
